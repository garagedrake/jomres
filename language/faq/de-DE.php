...
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_RESOURCEFEATURES', 'Was sind Raumfunktionssymbole?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_RESOURCEFEATURES', "Zimmerfunktionen können von Benutzern der Tarifbearbeitungsmodi Micromanage oder Advanced erstellt werden. Diese können mit einem oder mehreren Zimmern verknüpft werden und werden im Buchungsformular angezeigt. Nachdem Sie eine Zimmerfunktion erstellt haben, können Sie Laden Sie ein Bild für diese Funktion hoch, indem Sie zuerst die Raumfunktionen-Symbole im Dropdown-Menü im Media Center auswählen und dann den Namen der Raumfunktion aus der darunter angezeigten Dropdown-Liste auswählen.");
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_ROOMS', 'Wie lade ich Raumbilder hoch?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_ROOMS', 'Räume können von Benutzern der Tarifbearbeitungsmodi Micromanage oder Advanced erstellt werden. Nachdem ein oder mehrere Räume erstellt wurden, können Sie mehrere Bilder für jeden Raum über das Media Center hochladen (wählen Sie den Raumnamen/die Raumnummer nach Wählen Sie Zimmerbilder in der Dropdown-Liste aus. Diese Bilder können in einer Diashow angezeigt werden, indem Sie die Vorschauseite anzeigen, die Registerkarte Unsere Zimmer auswählen und dann auf den Link Verfügbarkeit klicken.');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_SLIDESHOW', 'Wie lade ich Diashow-Bilder hoch?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_SLIDESHOW', 'Diashow-Bilder werden auf der Seite Eigenschaftendetails ( Vorschau ) neben der Schaltfläche Jetzt buchen angezeigt.');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_EXTRAS', 'Wie lade ich Extras-Bilder hoch?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_EXTRAS', "Ähnlich wie bei den Räumen und Raumfunktionen müssen Sie zuerst ein Extra erstellen. Anschließend können Sie im oberen Dropdown-Menü Extras auswählen. Wenn Sie dies getan haben, müssen Sie den Namen auswählen das Extra aus der Dropdown-Liste unten. Wenn der Name ausgewählt ist, können Sie ein oder mehrere Bilder für dieses Extra hochladen.");
jr_define('_CASTOR_FAQ_GUEST_CATEGORY_SOMETHING', 'Etwas mit Gästen zu tun');
jr_define('_CASTOR_FAQ_GUEST_QUESTION_SOMEQUESTION', 'Wie blablabla?');
jr_define('_CASTOR_FAQ_GUEST_ANSWER_SOMEANSWER', 'Du blablabla ');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_LANGUAGES', 'Wie speichere ich Beschreibungen in mehreren Sprachen?');

jr_define('_CASTOR_FAQ_MANAGER_ANSWER_LANGUAGES', "Um Beschreibungen in mehreren Sprachen zu speichern, rufen Sie zuerst die Seite Einstellungen > Objektdetails auf. Speichern Sie dort die Beschreibung für Ihr Objekt. Ändern Sie als Nächstes die Sprache, in der Sie die Website anzeigen. Gehen Sie nun zu den Einstellungen Seite \"Eigenschaftsdetails\" erneut und speichern Sie die Details erneut. Wenn die Site also sowohl Englisch als auch Spanisch (oder eine andere) Sprache anzeigen kann, würden Sie Englisch auswählen, die Beschreibung auf Englisch eingeben und dann auf \"Speichern\" klicken. Als nächstes ändern Sie Ihre aktuelle Sprache in Spanisch, dann speichern Sie die neue spanische Beschreibung. Dies funktioniert für alle Eingaben auf dieser Seite.");
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_OTHERPROPERTIES', 'Kann ich andere Eigenschaften auf dieser Site ändern?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_OTHERPROPERTIES', 'Nein, das können Sie nicht. Sie können nur Objekte verwalten, die Sie angelegt haben oder denen Sie als Hausverwalter zugewiesen wurden.');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_OTHERPROPERTIES_SUPER', 'Kann ich andere Eigenschaften auf dieser Site ändern?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_OTHERPROPERTIES_SUPER', "Ja, Sie sind ein Super Property Manager und können alle Eigenschaften ändern, die auf der Seite List Properties angezeigt werden.");
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_GUESTTYPES', 'Was sind Gasttypen/Wie ändere ich pro Person und Nacht?');
...
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_ROOMFEATURES', 'Was sind Raumfunktionen?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_ROOMFEATURES', "Raumfunktionen sind Dinge, die den Raum hervorheben. Sie können etwas Einfaches sein wie Tee- und Kaffeezubereitungsmöglichkeiten, oder sie können Dinge sein, die den Raum wirklich über die anderen heben, wie \"Blick über die\" bay\". ( dort können die Gäste genau auswählen, welches Zimmer sie buchen möchten ) dann können sie die Zimmerfunktionen verwenden, um die im Buchungsformular angezeigten Zimmer zu filtern.");

jr_define('_CASTOR_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Zahlungen');
jr_define('_CASTOR_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_NOGATEWAY', "Sie können das Zahlungsgateway nach der Buchung nicht sehen.");
jr_define('_CASTOR_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY', "Wenn Sie als Property Manager angemeldet sind, sehen Sie das Zahlungsgateway nicht, da Sie nicht selbst bezahlen. Nur Benutzer ohne Manager sehen das Gateway bei Buchungen.");
