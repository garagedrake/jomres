...
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_RESOURCEFEATURES', 'Hvad er rumfunktionsikoner?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_RESOURCEFEATURES', "Rumfunktioner kan oprettes af brugere af Micromanage eller Avancerede takstredigeringsmetoder. Disse kan forbindes til et eller flere rum og vises i reservationsformularen. Når du har oprettet en rumfunktion, kan du uploade et billede til denne funktion ved først at vælge Ikoner for rumfunktioner i rullemenuen i Media Center og derefter vælge rumfunktionens navn fra rullemenuen, der vises nedenfor. ");
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_ROOMS', 'Hvordan uploader jeg rumbilleder?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_ROOMS', 'Værelser kan oprettes af brugere af Micromanage eller Avancerede tarifferedigeringstilstande. Når et eller flere rum er oprettet, kan du uploade flere billeder for hvert værelse via Media Center (vælg rumnavn/nummer efter at vælge værelsebilleder i rullemenuen). Disse billeder kan ses i et diasshow ved at se siden Preview og vælge fanen Our Rooms og derefter klikke på linket Tilgængelighed. ');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_SLIDESHOW', 'Hvordan uploader jeg diasshowbilleder?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_SLIDESHOW', 'Diasshowbilleder ses på ejendomsoplysningssiden (eksempel) ved siden af ​​knappen Book nu.');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_MEDIACENTRE_EXTRAS', 'Hvordan uploader jeg ekstra billeder?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_MEDIACENTRE_EXTRAS', "I lighed med værelser og rumfunktioner skal du først oprette en ekstra. Når det er gjort, kan du vælge Ekstra i øverste rullemenu. Når du har gjort det, skal du vælge navnet på ekstra fra rullelisten herunder. Når navnet er valgt, kan du uploade et eller flere billeder til det ekstra. ");
jr_define('_CASTOR_FAQ_GUEST_CATEGORY_SOMETHING', 'Noget gæstrelateret');
jr_define('_CASTOR_FAQ_GUEST_QUESTION_SOMEQUESTION', 'How do I blahblahblah?');
jr_define('_CASTOR_FAQ_GUEST_ANSWER_SOMEANSWER', 'Du blahblahblah');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_LANGUAGES', 'Hvordan gemmer jeg beskrivelser på flere sprog?');

jr_define('_CASTOR_FAQ_MANAGER_ANSWER_LANGUAGES', "For at gemme beskrivelser på flere sprog skal du først besøge siden Indstillinger> Ejendomsoplysninger. Gem beskrivelsen for din ejendom der. Skift derefter det sprog, du ser webstedet på. Gå nu til Indstillinger Ejendomsoplysningssiden igen, og gem oplysningerne igen. Så hvis webstedet er i stand til at vise både engelsk og spansk (eller andre) sprog, ville du vælge engelsk, indtaste beskrivelsen på engelsk og derefter klikke på Gem. Dernæst ændrer du dit nuværende sprog til spansk, gem derefter den nye spanske beskrivelse. Dette fungerer for alle input på den side. ");
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_OTHERPROPERTIES', 'Kan jeg ændre andre ejendomme på dette websted?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_OTHERPROPERTIES', 'Nej, det kan du ikke. Du kan kun administrere ejendomme, du har oprettet eller er blevet tildelt som ejendomsadministrator.');
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_OTHERPROPERTIES_SUPER', 'Kan jeg ændre andre ejendomme på dette websted?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_OTHERPROPERTIES_SUPER', "Ja det kan du, du er en Super Property Manager og kan ændre alle egenskaber, der vises på siden Listeegenskaber.");
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_GUESTTYPES', 'Hvad er gæstetyper/Hvordan ændrer jeg mig pr. person pr. nat?');
