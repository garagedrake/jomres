...
jr_define('_CASTOR_FAQ_MANAGER_QUESTION_ROOMFEATURES', 'Otaq Xüsusiyyətləri Nələrdir?');
jr_define('_CASTOR_FAQ_MANAGER_ANSWER_ROOMFEATURES', "Otaq xüsusiyyətləri, otağı fərqləndirən şeylərdir. Çay və Qəhvə hazırlama qurğuları kimi sadə bir şey ola bilər və ya otağı həqiqətən digərlərindən üstün tutan şeylər ola bilər. bay '. Otaq Xüsusiyyətini yaratdıqdan sonra, Media Mərkəzində bu xüsusiyyət üçün şəkillər yükləyə bilərsiniz. Bu otaq xüsusiyyətlərinə otaqların mövcudluğu səhifəsində baxıla bilər və mülkünüzü Klassik Otaqlar siyahısının üslubunu göstərmək üçün konfiqurasiya etmisinizsə. (qonaqların tam olaraq hansı otağı sifariş etmək istədiklərini seçə biləcəyi yerdə), sonra sifariş formasında göstərilən oomları süzmək üçün otaq xüsusiyyətlərindən istifadə edə bilərlər. ");

jr_define('_CASTOR_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Ödəmələr');
jr_define('_CASTOR_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_NOGATEWAY', "Sifariş verdikdən sonra ödəniş qapısını görə bilməzsiniz");
jr_define('_CASTOR_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY', "Əmlak meneceri olaraq daxil olsanız, ödəniş şluzunu görməyəcəksiniz, çünki özünüz ödəmirsiniz. Sifariş verərkən yalnız idarəçi olmayan istifadəçilər ağ geçidi görəcəklər.");
