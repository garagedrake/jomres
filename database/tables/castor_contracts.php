 ...
 **/
$query = "
CREATE TABLE IF NOT EXISTS `#__castor_contracts` (
	...
	`referrer` VARCHAR(255) NOT NULL DEFAULT 'Castor',
...
if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to create the #__castor_contracts table', 'danger');
}
