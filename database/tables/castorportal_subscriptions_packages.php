 ...
 **/
$query = "
CREATE TABLE IF NOT EXISTS `#__castorportal_subscriptions_packages` (
...
if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to create the #__castorportal_subscriptions_packages table', 'danger');
}
