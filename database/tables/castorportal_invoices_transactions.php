 ...
 **/
$query = "
CREATE TABLE IF NOT EXISTS `#__castorportal_invoices_transactions` (
...
if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to create the #__castorportal_invoices_transactions table', 'danger');
}
