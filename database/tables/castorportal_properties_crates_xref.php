 ...
 **/
$query = "
CREATE TABLE IF NOT EXISTS `#__castorportal_properties_crates_xref` (
...
if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to create the #__castorportal_properties_crates_xref table', 'danger');
}
