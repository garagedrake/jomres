 ...
 *
 **/
$query = "TRUNCATE TABLE `#__castor_room_classes`;";

if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to truncate #__castor_room_classes table', 'danger');
	
	return;
}

$query = "
INSERT INTO `#__castor_room_classes` (`room_classes_uid`, `room_class_abbv`, `room_class_full_desc`, `image`, `property_uid`) VALUES
...
if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to insert sample data in the #__castor_room_classes table', 'danger');
}
