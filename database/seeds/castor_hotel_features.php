 ...
 *
 **/
$query = "TRUNCATE TABLE `#__castor_hotel_features`;";

if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to truncate #__castor_hotel_features table', 'danger');
	
	return;
}

$query = "
INSERT INTO `#__castor_hotel_features` (`hotel_features_uid`, `hotel_feature_abbv`, `hotel_feature_full_desc`, `image`, `property_uid`, `ptype_xref`, `cat_id`, `include_in_filters`) VALUES
...
if (!doInsertSql($query)) {
	$this->setMessage('Error, unable to insert sample data in the #__castor_hotel_features table', 'danger');
}
