...
// ################################################################
	...
	/*
	 *
	 * Notes describing the uses of the variables
	 *
	 */
	$mrConfig_notes = array(
		'newTariffModels' => "This setting switched between Flat and Average tariff model. If it is set to Flat then the booking engine will take the price of the first day and apply that across all days, whereas with Average then each day of the tariff set is used to contruct the price of the day.",
		'singlePersonSuppliment' => 'Should a booking be charged a single person suppliment if only on person is occupying a room?',
		'singlePersonSupplimentCost' => 'Cost of the single person suppliment',
		'perPersonPerNight' => 'Charge the booking per person per night? If no, then guests are charged just for the cost of the room.',
		'depositIsPercentage' => 'Is the deposit charged a percentage of the booking, or a flat value?',
		'depositValue' => 'e.g. 20% or 20e? ',
		'errorChecking' => 'Obsolete value. Left in for backward compatability.',
		'castordotnet' => 'www.castor.net',
		'visitorscanbookonline' => 'Determines if non-registered users can use the booking form',
		'fixedPeriodBookings' => 'Are fixed period bookings allowed? If set to yes, instead of ',
		'fixedPeriodBookingsNumberOfDays' => 'The number of days a dropdown can span. Typically set to 7.',
		'numberofFixedPeriods' => 'How many date sets in the dropdown?',
		'singleRoomProperty' => '0',
		'fixedArrivalDateYesNo' => '0',
		'fixedArrivalDay' => '0',
		'showAvailabilityCalendar' => '1',
