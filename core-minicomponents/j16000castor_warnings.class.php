...
class j16000castor_warnings
{
	...
	public function __construct($componentArgs)
	{
		...
		$output['PROPERTY_TYPE_WARNING'] = $castor_property_types->get_property_types_with_no_room_types_assigned($show_link_to_room_types = true);
		...
		$tmpl->readTemplatesFromInput('castor_warnings.html');
