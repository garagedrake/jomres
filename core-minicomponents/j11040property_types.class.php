...
class j11040property_types
{
	...
	public function __construct($componentArgs)
	{
		...
		if (isset($castor_media_centre_images->site_images [$resource_type][$resource_id])) {
			$this->ret_vals = $castor_media_centre_images->site_images [$resource_type][$resource_id];
		} else {
			$this->ret_vals = array();
		}
	}
