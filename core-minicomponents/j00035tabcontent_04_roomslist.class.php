...
class j00035tabcontent_04_roomslist
{
	...
	public function __construct($componentArgs)
	{
		...
		$rooms_list_title = jr_gettext('_CASTOR_COM_MR_QUICKRES_STEP2_TITLE', '_CASTOR_COM_MR_QUICKRES_STEP2_TITLE', false);

		if ($mrConfig[ 'is_real_estate_listing' ] == 0) {
			if ($mrConfig[ 'roomslistinpropertydetails' ] == '1' && $mrConfig[ 'singleRoomProperty' ] != '1') {
				$anchor = castor_generate_tab_anchor($rooms_list_title);
