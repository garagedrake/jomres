...
// ################################################################
	...
	class j00003get_language_context
	{
		 ...
		 *
		 * It is designed to be used by shortcodes which will set their own language context by adding &language_context=XXX (eg &language_context=campsite) to the arguments. For that shortcode only, Castor will use language strings set in the Translate Lang Files page for the appropriate property type.
		 *
		...
		public function __construct($componentArgs)
		{
			...
			if (isset($_REQUEST['language_context']) && trim($_REQUEST['language_context']) != '') {
				$language_context = castorGetParam($_REQUEST, 'language_context', $jrConfig['language_context']);
