...
class j16000castor_income_overview
{
	...
	public function __construct($componentArgs)
	{
		...
		$query = "SELECT 
					...
					FROM 
						#__castorportal_lineitems a, 
						#__castorportal_invoices b 
					WHERE 
						a.inv_id = b.id 
		...
		$output['_CASTOR_INCOME_PAID_AMOUNTS'] = jr_gettext('_CASTOR_INCOME_PAID_AMOUNTS', '_CASTOR_INCOME_PAID_AMOUNTS', false);
		
		$output['_CASTOR_STATUS_BOOKINGS'] = jr_gettext('_CASTOR_STATUS_BOOKINGS', '_CASTOR_STATUS_BOOKINGS', false);
		...
		$tmpl->readTemplatesFromInput('castor_income_overview.html');
