...
class j03382slideshow
{
	...
	public function __construct($componentArgs)
	{
		...
		if (is_dir(CASTOR_IMAGELOCATION_ABSPATH . $defaultProperty . JRDS . 'gif' . JRDS))
			{
			emptyDir( CASTOR_IMAGELOCATION_ABSPATH . $defaultProperty . JRDS . 'gif' . JRDS );
			rmdir ( CASTOR_IMAGELOCATION_ABSPATH . $defaultProperty . JRDS . 'gif' . JRDS );
			}
