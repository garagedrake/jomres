...
class j16000castor_properties_overview
{
	...
	public function __construct($componentArgs)
	{
		...
		$query = 'SELECT COUNT(`propertys_uid`) AS cnt FROM #__castor_propertys WHERE `approved` = 0 ';
		...
		$output['_CASTOR_HLIST_PROPERTIES'] = jr_gettext('_CASTOR_HLIST_PROPERTIES', '_CASTOR_HLIST_PROPERTIES', false, false);
		...
		$tmpl->readTemplatesFromInput('castor_properties_overview.html');
