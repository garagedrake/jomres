...
class j06002delete_tariff_standard
{
	function __construct()
	{
		...
		$jrportal_rates->tarifftype_id = (int)castorGetParam($_REQUEST, 'tarifftypeid', 0);
		...
		castorRedirect(castorURL(CASTOR_SITEPAGE_URL . "&task=list_tariffs_standard"), $saveMessage);
	}
