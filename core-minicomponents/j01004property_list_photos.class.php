...
// ################################################################
	 ...
	 *
	 * Registers the photos layout for property search results/lists. These are the options that a user can choose to alter the layout they want to see properties displayed in.
	 */
...
class j01004property_list_photos
{
	...
	public function __construct($componentArgs)
	{
		...
		$property_list_layouts[ $this_plugin ] = array('layout' => 'list_properties_photos_layout.html', 'title' => jr_gettext('_CASTOR_PROPERTYLIST_LAYOUT_TILE', '_CASTOR_PROPERTYLIST_LAYOUT_TILE', false, false), 'path' => null);
	...
	{
		$output = array();
		$output[ ] = jr_gettext('_CASTOR_PROPERTYLIST_LAYOUT_TILE', '_CASTOR_PROPERTYLIST_LAYOUT_TILE');
