...
$query = 'SELECT userid FROM #__castor_managers LIMIT 2';
...
$admin_user = castor_cmsspecific_getCMS_users_admin_userdetails_by_id($admin_user_id);
...
// Looking to see if Castor is already installed in Joomla. If it is, we'll simply return true as there's nothing else to do
$query = "SELECT `element` FROM #__extensions WHERE `element` = 'com_castor' ";
...
$query = "INSERT INTO #__extensions	(
	...
	VALUES
	(
	'Castor','component','com_castor','',
	'1','1','1','0',
	'{\"name\":\"Castor\",\"type\":\"component\",\"creationDate\":\"2005-03-18\",\"author\":\"Vince Wooll\",\"copyright\":\"(C) 2005 - 2011 Vince Wooll. All rights reserved.\t\",\"authorEmail\":\"sales@castor.net\",\"authorUrl\":\"www.castor.net\",\"version\":\"7\",\"description\":\"Castor\",\"group\":\"\"}',
	'{}','Joomla\Component\Castor',
...
if ($component_id) {
	$query = "SELECT title FROM #__menu WHERE `link` = 'index.php?option=com_castor' LIMIT 1";
	$result = doSelectSql($query);
	if (empty($result)) {
		...
		$query = "INSERT INTO #__menu (
				...
				'main','Castor','Castor','Castor',
				'','index.php?option=com_castor','component',1,
				1,1," .$component_id.",
	...
	echo 'Unable to create main Castor admin menu option<br>';
}
