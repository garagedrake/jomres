...
// ################################################################
	 ...
	 *
	 */
class data_source_keywords extends castor_data_source_base
{
	public function build_data_cache_file()
	{
		...
		$query = "SELECT  `constant` , `customtext` , `language` FROM #__castor_custom_text WHERE 
																				`constant` LIKE '_CASTOR_CUSTOMTEXT_ROOMTYPE_DESCRIPTION_%' OR 
 																				`constant` LIKE '_CASTOR_CUSTOMTEXT_ROOMTYPE_CHECKINTIMES_%' OR 
                                                                                `constant` LIKE '_CASTOR_CUSTOMTEXT_ROOMTYPE_AREAACTIVITIES_%' OR  
                                                                                `constant` LIKE '_CASTOR_CUSTOMTEXT_ROOMTYPE_DIRECTIONS_%' OR  
                                                                                `constant` LIKE '_CASTOR_CUSTOMTEXT_ROOMTYPE_AIRPORTS_%' OR  
                                                                                `constant` LIKE 'CASTOR_CUSTOMTEXT_ROOMTYPE_OTHERTRANSPORT_%'";
