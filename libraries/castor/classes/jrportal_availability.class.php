...
class jrportal_availability
{
	...
	public function check_availability()
	{
		...
		$query="SELECT `room_bookings_uid` FROM #__castor_room_bookings WHERE `room_uid` IN (".castor_implode($this->room_uids).") AND `date` IN (".castor_implode($date_range, false).") ";
