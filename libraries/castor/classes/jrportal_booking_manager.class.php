...
class jrportal_booking_manager
{
	...
	public function guest_checkin()
	{
		...
		addBookingNote($this->contract_uid, $this->property_uid, jr_gettext('_CASTOR_MR_AUDIT_BOOKEDGUESTIN', '_CASTOR_MR_AUDIT_BOOKEDGUESTIN', false));
	...
	public function guest_checkout()
	{
		...
		addBookingNote($this->contract_uid, $this->property_uid, jr_gettext('_CASTOR_FRONT_MR_BOOKOUT_GUESTBOOKEDOUT', '_CASTOR_FRONT_MR_BOOKOUT_GUESTBOOKEDOUT', false));
