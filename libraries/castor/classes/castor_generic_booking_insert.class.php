...
class castor_generic_booking_insert
{
	...
	public function create_booking()
	{
		...
		try {
			...
			$insertSuccessful = insertInternetBooking($castorsession, $this->booking_details['depositpaidsuccessfully'], false, '', false);
...
//			}
		...
		$query = "SELECT contract_uid FROM #__castor_contracts WHERE tag LIKE '".$this->booking_details['booking_number']."' LIMIT 1";
	...
	private function init()
	{
		...
		$this->guest_details = array(
			...
			'email' => '',							// "notify@castor.net" ***** Required *****
			);
