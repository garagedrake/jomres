...
class castor_obsolete_file_handling
{
	...
	public function __construct()
	{
		...
		$this->dir_root = CASTORCONFIG_ABSOLUTE_PATH;
		$this->dir_castor = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS;
		$this->dir_api = CASTOR_API_ABSPATH;
		$this->dir_minicomponents = CASTOR_APP_ABSPATH;
		$this->dir_classes = CASTOR_CLASSES_ABSPATH;
		$this->dir_functions = CASTOR_FUNCTIONS_ABSPATH;
		$this->dir_libraries = CASTOR_LIBRARIES_ABSPATH;
		$this->dir_core_plugins = CASTOR_COREPLUGINS_ABSPATH;
		$this->dir_css = CASTOR_CSS_ABSPATH;
		$this->dir_javascript = CASTOR_JS_ABSPATH;
		$this->dir_vendor = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'vendor';

		$this->dir_templates_jqueryui_frontend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'jquery_ui'.JRDS.'frontend'.JRDS;
		$this->dir_templates_jqueryui_backend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'jquery_ui'.JRDS.'backend'.JRDS;
		$this->dir_templates_jqueryui_administrator = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'jquery_ui'.JRDS.'administrator'.JRDS;

		$this->dir_templates_bootstrap_frontend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap'.JRDS.'frontend'.JRDS;
		$this->dir_templates_bootstrap_backend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap'.JRDS.'backend'.JRDS;
		$this->dir_templates_bootstrap_administrator = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap'.JRDS.'administrator'.JRDS;

		$this->dir_templates_bootstrap3_frontend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap3'.JRDS.'frontend'.JRDS;
		$this->dir_templates_bootstrap3_backend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap3'.JRDS.'backend'.JRDS;
		$this->dir_templates_bootstrap3_administrator = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap3'.JRDS.'administrator'.JRDS;

		$this->dir_templates_bootstrap4_frontend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap4'.JRDS.'frontend'.JRDS;
		$this->dir_templates_bootstrap4_backend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap4'.JRDS.'backend'.JRDS;
		$this->dir_templates_bootstrap4_administrator = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap4'.JRDS.'administrator'.JRDS;

		$this->dir_templates_bootstrap5_frontend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap5'.JRDS.'frontend'.JRDS;
		$this->dir_templates_bootstrap5_backend = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap5'.JRDS.'backend'.JRDS;
		$this->dir_templates_bootstrap5_administrator = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'bootstrap5'.JRDS.'administrator'.JRDS;

		$this->dir_images = CASTOR_IMAGES_ABSPATH;
		$this->dir_images_large = CASTOR_IMAGES_ABSPATH.'castorimages'.JRDS.'large'.JRDS;
		$this->dir_images_small = CASTOR_IMAGES_ABSPATH.'castorimages'.JRDS.'small'.JRDS;

		$this->dir_components_administrator = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ADMINISTRATORDIRECTORY.JRDS.'components'.JRDS.'com_castor'.JRDS;
		$this->dir_components = CASTORCONFIG_ABSOLUTE_PATH.'components'.JRDS.'com_castor'.JRDS;

		$this->dir_node_modules = CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'node_modules'.JRDS;

		//castor filesystem
		//mount the site root dir, not the castor dir, so we can have access to castor_webinstall.php or cms files
	...
	private function set_default_obs_files_array()
	{
		...
		$this->add_file($this->dir_root.'castor_webinstall.php');
		...
		$this->add_file($this->dir_classes.'castorXMLParser.class.php');
		$this->add_file($this->dir_classes.'castor_contentTabs.class.php');
		...
		if (this_cms_is_joomla()) {
			$this->add_file($this->dir_components_administrator.'admin.castor.php');
		}
		...
		// 8.0
		$this->add_file($this->dir_classes.'castor_dashboard.class.php');
		...
		$this->add_dir($this->dir_castor.'templates'.JRDS.'castor');
		$this->add_dir($this->dir_castor.'libraries'.JRDS.'PHPMailer_v5.1');
		$this->add_dir($this->dir_castor.'javascript'.JRDS.'codemirror');
		$this->add_dir($this->dir_castor.'javascript'.JRDS.'jquerytabs');
		$this->add_dir($this->dir_castor.'javascript'.JRDS.'bootstrap_dashboard');
		$this->add_dir($this->dir_castor.'libraries'.JRDS.'bootstrap_dashboard');
		$this->add_dir($this->dir_castor.'templates'.JRDS.'jquery_ui'.JRDS.'templates');
		...
		$this->add_file($this->dir_classes.'castor_cache.class.php');
		...
		$this->add_file($this->dir_classes.'castor_property_maker.class.php');
		...
		$this->add_file($this->dir_classes.'castor_property_room_features.class.php');
		...
		$this->add_file($this->dir_classes.'castor_sticky_messages.class.php');
		...
		$this->add_file($this->dir_classes.'castor_css_cache.class.php');
		$this->add_file($this->dir_classes.'castor_javascript_cache.class.php');
		...
		$this->add_file($this->dir_classes.'castor_pathway.class.php');
		...
		$this->add_file($this->dir_classes.'castor_custom_template_handler.class.php');
		...
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'castorsa'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla15'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla16'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla17'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla25'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla30'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla31'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla32'.JRDS);
		$this->add_dir($this->dir_libraries.'castor'.JRDS.'cms_specific'.JRDS.'joomla33'.JRDS);
		...
		$this->add_file($this->dir_minicomponents.'j16000about_castor.class.php');
		$this->add_file($this->dir_minicomponents.'j16000about_shortcodes.class.php');

		$this->add_file($this->dir_classes.'castor_pageview_record.class.php');
		...
		$this->add_file($this->dir_minicomponents.'j16000castor_writability_check.class.php');
		...
		$this->add_file($this->dir_classes.'castor_access_control_controlable.class.php');
		$this->add_file($this->dir_minicomponents.'j10501contact_settings.class.php');
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'admin'.JRDS);
		...
		$this->add_file($this->dir_minicomponents.'j16000castor_overview.class.php');
		...
		$this->add_file($this->dir_minicomponents.'j99995castor_mainmenu.class.php');
		...
		$this->add_file($this->dir_classes.'castor_performance_monitor.class.php');
		$this->add_file($this->dir_minicomponents.'j16000delete_template.class.php');
		$this->add_file($this->dir_classes.'castor_usage_reporting.class.php');
		...
		$this->add_file($this->dir_classes.'castor_frontend_configuration_level.class.php');
		...
		$this->add_file($this->dir_classes.'castor_qr_code.class.php');

		$this->add_dir($this->dir_libraries.JRDS.'simpleMDE'.JRDS);
		$this->add_dir($this->dir_libraries.JRDS.'map_styles'.JRDS);
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'css'.JRDS);
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'javascript'.JRDS);
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'images'.JRDS);
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'fonts'.JRDS);
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'templates'.JRDS);
		...
		if (this_cms_is_joomla()) {
			$this->add_file($this->dir_components_administrator.'castor_webinstall.php');
		}

		$this->add_file($this->dir_castor.'install_castor.php');
		$this->add_file($this->dir_classes.'castor_uninstall.class.php');
		...
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'templates'.JRDS.'jquery_ui');
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'dashboard');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'icons.zip');
		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'alternative_icons');

		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'1bedroom.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'2bedrooms.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'3bedrooms.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'4bedrooms.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'5bedrooms.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'6plusbedrooms.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'24hour.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'air_conditioning.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'airport_nearby.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'baby_friendly.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'balcony.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'bar.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'bar2.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'bath_tub.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'bbq_facilities.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'beach.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'beach2.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'bird_hide.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'campfire.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_1bivi_pitch.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_2_man_tent_pitch.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_3_man_tent_pitch.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_4_man_tent_pitch.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_6_man_tent_pitch.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_area.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'camping_caravan_pitch.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'canoeing.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'car_rental_hatchback.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'car_rental_luxury.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'car_rental_peoplecarrier.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'car_rental_saloon.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'car_rental_sportscar.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'caravan.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'casino.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'CDplayer.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'cinema.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'concierge.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'conference_facilities.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'cycle_paths.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'disabled_access.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'disabled_facilities.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'disco.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'dogs_not_permitted.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'dogs_permitted.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'double.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'drinking_water.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'DVDVideo.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'elevator.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'facilities_Disabled_Access.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'facilities_Disabled_Facilities.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'facilities_Dogs_Not_Permitted.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'facilities_Dogs_Permitted.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'facilities_Information.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'facilities_Internet.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fees.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fees_euro.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fees_pound.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fireplace.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fishing.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fishing2.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'forrest_nearby.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fourposter.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fourwd_access.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'fridge.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'garden.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'gardens.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'gastronomicrestaurant.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'giftshop.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'golf.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'groups.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'guided_tours.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'gym.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'gym2.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'hairdresser.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'hairdryer.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'helicopterpad.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'hiking.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'historichouses.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'honeymoon_friendly.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'hotel_safe.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'in_room_teacoffee.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'info2.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'information.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'internet.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'iron.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'jacuzzi.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'language.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'laundry_service.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'medicare.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'meeting_room.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'microwaves.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'mountain_bike.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'no_smoking.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'Ownermanaged.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'parking.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'pets_welcome.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'picnic_area.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'pool.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'ranger.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'restraunt.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'restraunt2.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'room_service.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'sailing.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'scuba.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'shower_only.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'shuttle_service.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'single.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'Skionsite.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'smokers_welcome.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'snorkelling.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'telephone.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'tennis.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'toilets.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'tv_in_room.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'twin.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'valet_parking.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'visitor_centre.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'walking.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'wc.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'weddings.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'whalewatching.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'wifi.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'wildlife.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'xmas_partys.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'yacht_2_berth.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'yacht_4_berth.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'yacht_6_berth.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'yacht_8_berth.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'icons'.JRDS.'zodiacexcursions.png');

		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'markers'.JRDS.'PSD.psd');

		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'31.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'add_review.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'arrivetoday.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'arrivetoday2.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'arrow_right_grey.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'back_disabled.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'back_enabled.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'btn_paynowCC_LG.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'bug_icon.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'calendar_msg_bubble.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'cart_red_transparent.png');

		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'ChartBarTrend.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'ChartTrend.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'clear.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'clickatell.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'clickatell_logo.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'departtoday.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Dogs-Trust-Logo.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'down.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'FAQ.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Find.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'forward_disabled.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'forward_enabled.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Help.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'info.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'large_warning.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'late.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'loading.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'notarrived.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'pending.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'plugin_manager.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'PostNote.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'price-tag.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'resident.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Secured.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'send.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'send.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Services.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'stillhere.gif');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Support_IT.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'SymbolInformation.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'totals_panel_bg.jpg');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'valid.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'warning.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'writability_check_failed.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'writability_check_passed.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'Tourists.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'User_Agent_Male.png');
		$this->add_file(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'assets'.JRDS.'images'.JRDS.'User_Ninja.png');


		$this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'libraries'.JRDS.'node_modules');
		// $this->add_dir(CASTORCONFIG_ABSOLUTE_PATH.CASTOR_ROOT_DIRECTORY.JRDS.'libraries'.JRDS.'vendor'); Removed because Stripe SDK now uses it
	...
	public function remove_obsolete_files()
	{
		foreach ($this->obs_directories as $path) {
			if (!$this->filesystem->deleteDir('local://'.str_replace(CASTORCONFIG_ABSOLUTE_PATH, '', $path))) {
				throw new Exception('Could not remove obsolete dir '.$path);
			}
		}

		foreach ($this->obs_files as $path_and_file) {
			if (!$this->filesystem->delete('local://'.str_replace(CASTORCONFIG_ABSOLUTE_PATH, '', $path_and_file))) {
