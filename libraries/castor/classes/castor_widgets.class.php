...
class castor_widgets
{
	...
	public function get_widgets_dropdown()
	{
		...
		<div class="button-group">
			<button type="button" class="btn btn-default dropdown-toggle" '.$data_toggle.'="dropdown"><span class="fa fa-cog"></span> '.jr_gettext('_CASTOR_SELECT_WIDGETS', '_CASTOR_SELECT_WIDGETS', false).' <span class="caret"></span></button>
		...
		<script type="text/javascript">
			var jr_widgets_selected = [' . castor_implode($checked_options_js, false) . ']
		</script>
		';
