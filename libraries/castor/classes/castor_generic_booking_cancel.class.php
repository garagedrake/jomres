...
class castor_generic_booking_cancel
{
	...
	private function validate()
	{
		...
		$query = "SELECT contract_uid, booked_in, bookedout, cancelled FROM #__castor_contracts WHERE contract_uid = '".(int) $this->contract_uid."' ";
	...
	private function apply_cancellation()
	{
		...
		$query = "DELETE FROM #__castor_room_bookings 
		...
		$query = "UPDATE #__castor_contracts 
					SET `cancelled`='1', 
