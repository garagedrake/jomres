...
class castor_management_view
{
	...
	public function get_dropdown()
	{
		...
		if (isset($_REQUEST[ 'tmpl' ])) {
			$response = ' <a href="'.$this->remove_querystring_var('tmpl').'">'.jr_gettext('_CASTOR_COM_MANAGEMENTVIEW_SITEPREVIEW', '_CASTOR_COM_MANAGEMENTVIEW_SITEPREVIEW', false).'</a>';
		} else {
			$response = '<a href="'.$curPageUrl.$connector.'tmpl='.get_showtime('tmplcomponent').'" class="btn btn-default btn-secondary"><i class="fa fa-arrows-alt"></i> '.jr_gettext('_CASTOR_COM_MANAGEMENTVIEW_MANAGMENT', '_CASTOR_COM_MANAGEMENTVIEW_MANAGMENT', false).'</a>';
		}
