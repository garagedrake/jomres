...
class castor_input_filter_singleton
{
	...
	private function init()
	{
		...
		/* if (!class_exists('HTMLPurifier')) {
			require_once CASTOR_LIBRARIES_ABSPATH.'htmlpurifier'.JRDS.'htmlpurifier-4.4.0-standalone'.JRDS.'HTMLPurifier.standalone.php';
		} */
