...
class castor_contract_secret_key
{
	...
	public function generate_secret_key()
	{
		...
		$keeplooking = true;
		while ($keeplooking) :
			$secret_key = generateCastorRandomString(50);
			$query = "SELECT secret_key FROM #__castor_contracts WHERE secret_key = '".$secret_key."' LIMIT 1";
	...
	public function save_secret_key($secret_key, $contract_uid)
	{
		...
		try {
			$query = "UPDATE #__castor_contracts SET `secret_key` = '".$secret_key."' WHERE `contract_uid` = ".$contract_uid;
	...
	{
		$query = "SELECT `secret_key` FROM #__castor_contracts WHERE `contract_uid` = '".$contract_uid."' LIMIT 1";
	...
	{
		$query = "SELECT `contract_uid` FROM #__castor_contracts WHERE `secret_key` = '".$secret_key."' LIMIT 1";
	...
	{
		$query = "SELECT `secret_key` FROM #__castor_contracts WHERE `secret_key` = '".$secret_key."' ";
	...
	{
		$query = "SELECT `secret_key_used` FROM #__castor_contracts WHERE `secret_key` = '".$secret_key."' LIMIT 1";
