...
class castor_gdpr_optin_consent
{
	...
	public function user_consents_to_storage()
	{
		...
		if ((int)$_COOKIE['castor_gdpr_consent_form_processed'] == 0) {
			return false;
		}
		return true;
	}
	...
	public function save_record()
	{
		...
		if ($tmpBookingHandler->ip == "0.0.0.0") {
			header('Set-Cookie: castor_gdpr_consent_form_processed='.(int)$this->optedin.'; expires=Fri, 31-Dec-9999 23:59:59 GMT');
			return;
		}
		
		$query = "INSERT INTO #__castor_gdpr_optins
			(
				`date_time`,
				`user_id`,
				`ip`,
