...
class jrportal_subscriptions
{
	...
	public function getSubscriptionPackage()
	{
		...
		$query = 'SELECT 
						...
						`renewal_price`,
						`params`
					FROM #__castorportal_subscriptions_packages 
	...
	public function commitSubscriptionPackage()
	{
		...
		$query = "INSERT INTO #__castorportal_subscriptions_packages
								(
								`name`,
								`description`,
								`published`,
	...
	public function commitUpdateSubscriptionPackage()
	{
		...
		$query = "UPDATE #__castorportal_subscriptions_packages SET
	...
	public function deleteSubscriptionPackage()
	{
		...
		$query = 'DELETE FROM #__castorportal_subscriptions_packages WHERE `id` = '.(int) $this->package['id'];
		$result = doInsertSql($query, '');
	...
	public function getSubscription()
	{
		...
		$query = 'SELECT 
						...
						`expiration_date`,
						`invoice_id`
					FROM #__castorportal_subscriptions 
	...
	public function commitSubscription()
	{
		...
		$query = 'INSERT INTO #__castorportal_subscriptions
						(
						`cms_user_id`,
						`package_id`,
						`status`,
	...
	public function commitUpdateSubscription()
	{
		...
		$query = 'UPDATE #__castorportal_subscriptions SET
	...
	public function deleteSubscription()
	{
		...
		$query = 'DELETE FROM #__castorportal_subscriptions WHERE `id` = '.(int) $this->subscription['id'];
		$result = doInsertSql($query, '');
	...
	public function subscriptionPackageIsUsed()
	{
		...
		$query = 'SELECT `id` FROM #__castorportal_subscriptions WHERE `package_id` = '.(int) $this->package['id'].' LIMIT 1 ';
