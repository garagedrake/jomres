...
class jrportal_coupons
{
	...
	public function commit_new_coupon()
	{
		...
		$query = "INSERT INTO #__castor_coupons
							(
							`coupon_id`,
							`property_uid`,
							`coupon_code`,
	...
	public function delete_coupon()
	{
		...
		if ($this->get_coupon()) {
			$query = 'DELETE FROM #__castor_coupons WHERE `coupon_id` = '.(int)$this->id.' AND `property_uid` = '.(int)$this->property_uid;
			if (!doInsertSql($query, '')) {
