...
class castor_deferred_tasks
{
	...
	{
		$this->queued_tasks_dir = CASTOR_TEMP_ABSPATH.JRDS.'deferred_tasks'.JRDS;
	...
	public function construct_background_message($trigger_number = '', $minicomponent = '', $payload = '')
	{
		...
		$randomstring = generateCastorRandomString(50);
	...
	public function dispatch_mesage()
	{
		...
		$url = CASTOR_SITEPAGE_URL_AJAX."&task=background_process&payload_source=".$this->file_identifier;
