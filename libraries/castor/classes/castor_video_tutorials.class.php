...
class castor_video_tutorials
{
	...
	public function build_modal()
	{
		...
		if (!empty($videos)) {
			...
			} elseif (!castor_cmsspecific_areweinadminarea()) {
				$tmpl->setRoot(CASTOR_TEMPLATEPATH_FRONTEND);
	...
	private function get_videos_array()
	{
		...
		if ($thisJRUser->userIsManager) {
			$arr = array ("title" => "_CASTOR_TUTORIAL_CPANEL" , "description" => "_CASTOR_TUTORIAL_CPANEL_DESC" , "video_id" => "pIlliA6uJrU" );
			$videos_array['SRP']['cpanel'][] = $arr;
			$videos_array['MRP']['cpanel'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_TIMELINE" , "description" => "_CASTOR_TUTORIAL_TIMELINE_DESC" , "video_id" => "0RuJCedh0CQ" );
			$videos_array['SRP']['dashboard'][] = $arr;
			$videos_array['MRP']['dashboard'][] = $arr;
			$videos_array['SRP']['cpanel'][] = $arr;
			$videos_array['MRP']['cpanel'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_LISTPROPERTIES" , "description" => "_CASTOR_TUTORIAL_LISTPROPERTIES_DESC" , "video_id" => "6VL-iSS2go0" );
			...
			$arr = array ("title" => "_CASTOR_TUTORIAL_EDIT_PROPERTY_MRP" , "description" => "_CASTOR_TUTORIAL_EDIT_PROPERTY_MRP_DESC" , "video_id" => "oCtqbQyLdmU" );
			$videos_array['SRP']['edit_property'][] = $arr;
			$videos_array['MRP']['edit_property'][] = $arr;
			$videos_array['TOUR']['listyourproperties'][] = $arr;
			$videos_array['REALESTATE']['listyourproperties'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_NORMAL_TARIFF_EDITING_MODE_MRP" , "description" => "_CASTOR_TUTORIAL_NORMAL_TARIFF_EDITING_MODE_MRP_DESC" , "video_id" => "l2WlWJ6CkWo" );
			$videos_array['MRP']['edit_tariffs_normal'][] = $arr;
			$videos_array['MRP']['business_settings'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_NORMAL_TARIFF_EDITING_MODE_SRP" , "description" => "_CASTOR_TUTORIAL_NORMAL_TARIFF_EDITING_MODE_SRP_DESC" , "video_id" => "3_WWa7fD8-A" );
			$videos_array['SRP']['edit_tariffs_normal'][] = $arr;
			$videos_array['SRP']['business_settings'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_MICROMANAGE_TARIFF_EDITING_MODE_MRP" , "description" => "_CASTOR_TUTORIAL_MICROMANAGE_TARIFF_EDITING_MODE_MRP_DESC" , "video_id" => "F8vfL3Ph96U" );
			$videos_array['MRP']['list_tariffs_micromanage'][] = $arr;
			$videos_array['MRP']['business_settings'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_MICROMANAGE_TARIFF_EDITING_MODE_SRP" , "description" => "_CASTOR_TUTORIAL_MICROMANAGE_TARIFF_EDITING_MODE_SRP_DESC" , "video_id" => "yOzfwV6ncr4" );
			$videos_array['SRP']['list_tariffs_micromanage'][] = $arr;
			$videos_array['SRP']['business_settings'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_MICROMANAGE_TARIFF_EDITING_MODE_MORE_GUESTS_MRP" , "description" => "_CASTOR_TUTORIAL_MICROMANAGE_TARIFF_EDITING_MODE_MORE_GUESTS_MRP_DESC" , "video_id" => "oX_YKZbHKxw" );
			$videos_array['MRP']['list_tariffs_micromanage'][] = $arr;
			$videos_array['MRP']['business_settings'][] = $arr;
			
			/*$arr = array ("title" => "_CASTOR_TUTORIAL_MICROMANAGE_GUEST_TYPES" , "description" => "_CASTOR_TUTORIAL_MICROMANAGE_GUEST_TYPES_DESC" , "video_id" => "ty61n8l2qVI" );
			$videos_array['MRP']['list_tariffs_micromanage'][] = $arr;
			$videos_array['MRP']['business_settings'][] = $arr;
			...
			$arr = array ("title" => "_CASTOR_TUTORIAL_MEDIA_CENTRE_MRP" , "description" => "_CASTOR_TUTORIAL_MEDIA_CENTRE_MRP_DESC" , "video_id" => "azlhJ28mrdU" );
			$videos_array['MRP']['cpanel'][] = $arr;
			...
			$arr = array ("title" => "_CASTOR_TUTORIAL_MEDIA_CENTRE_SRP" , "description" => "_CASTOR_TUTORIAL_MEDIA_CENTRE_SRP_DESC" , "video_id" => "pNnPCxQT3YM" );
			$videos_array['SRP']['cpanel'][] = $arr;
		...
		if (castor_cmsspecific_areweinadminarea()) {
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_CPANEL" , "description" => "_CASTOR_TUTORIAL_ADMIN_CPANEL_DESC" , "video_id" => "19_Nx_xSVl0" );
			$videos_array['ADMIN']['cpanel'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_ADD_PROPERTY" , "description" => "_CASTOR_TUTORIAL_ADMIN_ADD_PROPERTY_DESC" , "video_id" => "qU9Zr2DlYm4" );
			$videos_array['ADMIN']['cpanel'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_COMPLETING_PROPERTY" , "description" => "_CASTOR_TUTORIAL_ADMIN_COMPLETING_PROPERTY_DESC" , "video_id" => "pvK-qaF77eo" );
			$videos_array['ADMIN']['cpanel'][] = $arr;
			$videos_array['ADMIN']['property_approvals'][] = $arr;
			
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_PLUGIN_MANAGER" , "description" => "_CASTOR_TUTORIAL_ADMIN_PLUGIN_MANAGER_DESC" , "video_id" => "Ld3X4Swx4c4" );
			$videos_array['ADMIN']['cpanel'][] = $arr;
			$videos_array['ADMIN']['showplugins'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_PROPERTY_MANAGERS" , "description" => "_CASTOR_TUTORIAL_ADMIN_PROPERTY_MANAGERS_DESC" , "video_id" => "v3Ilb7xD78k" );
			$videos_array['ADMIN']['list_users'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_ACCESS_CONTROL" , "description" => "_CASTOR_TUTORIAL_ADMIN_ACCESS_CONTROL_DESC" , "video_id" => "kQRA4tJSZfM" );
			$videos_array['ADMIN']['access_control'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_PROPERTY_TYPES" , "description" => "_CASTOR_TUTORIAL_PROPERTY_TYPES_DESC" , "video_id" => "LGsEuy4FD2k" );
			...
			$arr = array ("title" => "_CASTOR_TUTORIAL_UPLOADING_MAP_MARKERS" , "description" => "_CASTOR_TUTORIAL_UPLOADING_MAP_MARKERS_DESC" , "video_id" => "x2EFJoNG0hA" );
			$videos_array['ADMIN']['media_centre'][] = $arr;
			$videos_array['ADMIN']['list_property_types'][] = $arr;
			$videos_array['ADMIN']['edit_property_type'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_PROPERTY_FEATURES" , "description" => "_CASTOR_TUTORIAL_PROPERTY_FEATURES_DESC" , "video_id" => "_tUzSU3BeWE" );
			$videos_array['ADMIN']['listPfeatures'][] = $arr;
			$videos_array['ADMIN']['editPfeature'][] = $arr;
			
			$arr = array ("title" => "_CASTOR_TUTORIAL_SHORTCODES" , "description" => "_CASTOR_TUTORIAL_SHORTCODES_DESC" , "video_id" => "JwEwmxrG4c8" );
			$videos_array['ADMIN']['asamodule_report'][] = $arr;

			
			$arr = array ("title" => "_CASTOR_TUTORIAL_LOGFILES" , "description" => "_CASTOR_TUTORIAL_LOGFILES_DESC" , "video_id" => "lvImwRgJ6k0" );
			$videos_array['ADMIN']['list_error_logs'][] = $arr;
			$videos_array['ADMIN']['view_log_file'][] = $arr;

			
			$arr = array ("title" => "_CASTOR_TUTORIAL_TRANSLATIONS" , "description" => "_CASTOR_TUTORIAL_TRANSLATIONS_DESC" , "video_id" => "no5PSDuzBzo" );
			...
			$arr = array ("title" => "_CASTOR_TUTORIAL_ADMIN_PROPERTY_CATEGORIES" , "description" => "_CASTOR_TUTORIAL_ADMIN_PROPERTY_CATEGORIES_DESC" , "video_id" => "Rx7cwCLJrzc" );
