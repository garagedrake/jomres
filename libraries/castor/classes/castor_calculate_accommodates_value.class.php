...
class castor_calculate_accommodates_value
{
	...
	public function calculate_accommodates_value()
	{
		...
		if (!isset($mrConfig['accommodates'])) {
			...
			$query = "UPDATE #__castor_settings SET `value` = ".($accommodates_total)." WHERE `property_uid` = ".(int) $this->property_uid." AND `akey` = 'accommodates' ";
		}
		...
		if (!isset($mrConfig['accommodates_adults'])) {
			...
			$query = "UPDATE #__castor_settings SET `value` = ".$accommodates_adults." WHERE `property_uid` = ".(int) $this->property_uid." AND `akey` = 'accommodates_adults' ";
		}
		...
		if (!isset($mrConfig['accommodates_children'])) {
			...
			$query = "UPDATE #__castor_settings SET `value` = ".$accommodates_children." WHERE `property_uid` = ".(int) $this->property_uid." AND `akey` = 'accommodates_children' ";
		}
