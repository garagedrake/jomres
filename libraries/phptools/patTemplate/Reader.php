...
class patTemplate_Reader extends patTemplate_Module
	...
	function _prepareTmplAttributes( $attributes, $templatename )
		...
		if ( isset( $attributes[ 'src' ] ) )
			...
			if ( !isset( $attributes[ 'reader' ] ) ) $attributes[ 'reader' ] = $this->getName();
			if ( !isset( $attributes[ 'autoload' ] ) ) $attributes[ 'autoload' ] = $this->_defaultAtts[ 'autoload' ];
	...
	function _handleVariable( $attributes, $data )
		...
		if ( isset( $attributes[ 'modifier' ] ) )
			...
			if ( isset( $attributes[ 'modifiertype' ] ) ) unset( $attributes[ 'modifiertype' ] );
