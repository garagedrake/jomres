        ...
        if (!empty($matches))
        {
            foreach ($matches[0] as $m)
            {
                ...
                if (isset($_REQUEST['language_context'])) {
                    ...
                    if (in_array($_REQUEST['language_context'],$valid_language_contexts)) {
                        $jrConfig[ 'language_context' ] = $_REQUEST['language_context'];
                    } else {
                        $jrConfig[ 'language_context' ] = $old_language_context;
                    }
                    set_showtime('property_type', $jrConfig[ 'language_context' ]);
                }
